                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.containers}>
                        ...
                        <Text style={{ fontSize: 30, marginTop: 30, fontWeight: 'Bold', textAlign: 'center' }}>CANDIDATE
                            ...
                            <Text style={{ color: 'orange', }}>  TENANCY
                        ...
                        <View style={styles.containerss}>
                            ...
                            <View style={[styles.inputWithLabel, { marginHorizontal: 10 }]}>
                                <Text style={styles.labelText}>House Owner Name</Text>
                                <TextInput style={styles.input} placeholder="Enter Your House Owner Name" keyboardType='text-pad' />
                            </View>
                            ...
                            <View style={[styles.inputWithLabel, { marginHorizontal: 10 }]}>
                                <Text style={styles.labelTexts}>Residing Date</Text>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row' }}>
                            <View style={{ marginRight: 20 }}>
                                <TouchableOpacity style={styles.buttonss}>
                                    <Text style={[styles.testss]} onPress={() => navigation.navigate('BackgroundForm4')}>Previous</Text>
                                </TouchableOpacity>
                            </View>
